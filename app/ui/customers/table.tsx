import { fetchFilteredCustomers } from "@/app/lib/data/data-customers";
...
export default async function CustomersTable({
  ...
  let customers = await fetchFilteredCustomers(query, currentPage, limit);
            ...
            <div className="md:hidden">
              {customers?.map((customer) => (
                ...
                >
                  ...
                  <div className="pt-4 text-sm underline text-blue-800">
                    <Link href={`/dashboard/invoices?query=${customer.email}`}>
              ...
              <tbody className="divide-y divide-gray-200 text-gray-900">
                {customers.map((customer) => (
                  <tr key={customer.id} className="group">
                    ...
                    <td className="whitespace-nowrap bg-white px-4 py-3 text-sm underline text-blue-800">
                      <Link
                        href={`/dashboard/invoices?query=${customer.email}`}
                      >
